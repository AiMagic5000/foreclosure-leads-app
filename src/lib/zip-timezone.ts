/**
 * US ZIP code prefix (first 3 digits) to IANA timezone mapping.
 * Covers all US ZIP codes. Where a prefix spans two timezones,
 * the majority timezone is used.
 */

const ZIP_PREFIX_TO_TZ: Record<string, string> = {
  // CT, MA, ME, NH, NJ, NY (partial), PR, RI, VT, VI
  ...
  // AE, NY
  "090": "America/New_York", "091": "America/New_York", "092": "America/New_York", "093": "America/New_York",
  "094": "America/New_York", "095": "America/New_York", "096": "America/New_York", "097": "America/New_York",
  "098": "America/New_York", "099": "America/New_York",
  // NY
  ...
  "212": "America/New_York", "213": "America/New_York", "214": "America/New_York", "215": "America/New_York",
  "216": "America/New_York", "217": "America/New_York", "218": "America/New_York", "219": "America/New_York",
  ...
  "278": "America/New_York", "279": "America/New_York", "280": "America/New_York", "281": "America/New_York",
  "282": "America/New_York", "283": "America/New_York", "284": "America/New_York", "285": "America/New_York",
  "286": "America/New_York", "287": "America/New_York", "288": "America/New_York", "289": "America/New_York",
  // SC
  ...
  "308": "America/New_York", "309": "America/New_York", "310": "America/New_York", "311": "America/New_York",
  "312": "America/New_York", "313": "America/New_York", "314": "America/New_York", "315": "America/New_York",
  "316": "America/New_York", "317": "America/New_York", "318": "America/New_York", "319": "America/New_York",
  // FL
  ...
  "337": "America/New_York", "338": "America/New_York", "339": "America/New_York",
  // FL panhandle 324/325 are Central Time but majority of those prefixes are Eastern
  // keeping Eastern for simplicity since most FL leads are East coast
  // AL
  "350": "America/Chicago", "351": "America/Chicago", "352": "America/Chicago", "353": "America/Chicago",
  "354": "America/Chicago", "355": "America/Chicago", "356": "America/Chicago", "357": "America/Chicago",
  "358": "America/Chicago", "359": "America/Chicago", "360": "America/Chicago", "361": "America/Chicago",
  "362": "America/Chicago", "363": "America/Chicago", "364": "America/Chicago", "365": "America/Chicago",
  "366": "America/Chicago", "367": "America/Chicago", "368": "America/Chicago", "369": "America/Chicago",
  // TN
  "370": "America/New_York", "371": "America/New_York", "372": "America/New_York", "373": "America/New_York",
  "374": "America/New_York",
  "375": "America/Chicago", "376": "America/Chicago", "377": "America/Chicago", "378": "America/Chicago",
  "379": "America/Chicago", "380": "America/Chicago", "381": "America/Chicago", "382": "America/Chicago",
  "383": "America/Chicago", "384": "America/Chicago", "385": "America/Chicago",
  // MS
  ...
  "407": "America/New_York", "408": "America/New_York", "409": "America/New_York",
  ...
  "420": "America/Chicago", "421": "America/Chicago", "422": "America/Chicago", "423": "America/Chicago",
  "424": "America/Chicago", "425": "America/Chicago", "426": "America/Chicago", "427": "America/Chicago",
  // OH
  ...
  "469": "America/Chicago", "470": "America/Chicago", "471": "America/Chicago", "472": "America/Chicago",
  "473": "America/Chicago", "474": "America/Chicago", "475": "America/Chicago", "476": "America/Chicago",
  "477": "America/Chicago", "478": "America/Chicago", "479": "America/Chicago",
  // MI
  ...
  "488": "America/New_York", "489": "America/New_York", "490": "America/New_York", "491": "America/New_York",
  "492": "America/New_York", "493": "America/New_York", "494": "America/New_York", "495": "America/New_York",
  "496": "America/New_York", "497": "America/New_York", "498": "America/New_York", "499": "America/New_York",
  // IA
  ...
  "639": "America/Chicago", "640": "America/Chicago", "641": "America/Chicago", "644": "America/Chicago",
  "645": "America/Chicago", "646": "America/Chicago", "647": "America/Chicago", "648": "America/Chicago",
  "649": "America/Chicago", "650": "America/Chicago", "651": "America/Chicago", "652": "America/Chicago",
  "653": "America/Chicago", "654": "America/Chicago", "655": "America/Chicago", "656": "America/Chicago",
  "657": "America/Chicago", "658": "America/Chicago",
  // KS
  "660": "America/Chicago", "661": "America/Chicago", "662": "America/Chicago", "664": "America/Chicago",
  "665": "America/Chicago", "666": "America/Chicago", "667": "America/Chicago", "668": "America/Chicago",
  "669": "America/Chicago", "670": "America/Chicago", "671": "America/Chicago", "672": "America/Chicago",
  "673": "America/Chicago", "674": "America/Chicago", "675": "America/Chicago", "676": "America/Chicago",
  "677": "America/Chicago", "678": "America/Chicago", "679": "America/Chicago",
  // NE
  ...
  "714": "America/Chicago",
  // AR
  "716": "America/Chicago", "717": "America/Chicago", "718": "America/Chicago", "719": "America/Chicago",
  "720": "America/Chicago", "721": "America/Chicago", "722": "America/Chicago", "723": "America/Chicago",
  ...
  "770": "America/Chicago", "772": "America/Chicago", "773": "America/Chicago", "774": "America/Chicago",
  "775": "America/Chicago", "776": "America/Chicago", "777": "America/Chicago", "778": "America/Chicago",
  "779": "America/Chicago", "780": "America/Chicago", "781": "America/Chicago", "782": "America/Chicago",
  "783": "America/Chicago", "784": "America/Chicago", "785": "America/Chicago", "786": "America/Chicago",
  ...
  // ID
  "832": "America/Boise", "833": "America/Boise", "834": "America/Boise", "835": "America/Boise",
  "836": "America/Boise", "837": "America/Boise", "838": "America/Boise",
  // UT
  ...
  // Navajo Nation in AZ observes DST
  "863": "America/Denver",
  // NM
  ...
  // Guam, AP
  "969": "Pacific/Guam",
  // Virgin Islands (008 already mapped above via PR block)
}

// State abbreviation fallback (for when zip is missing)
 ...
 * Falls back to state abbreviation, then Eastern.
 */
export function getTimezoneForZip(zipCode: string, stateAbbr?: string): string {
  if (zipCode && zipCode.length >= 3) {
    const prefix = zipCode.substring(0, 3)
    const tz = ZIP_PREFIX_TO_TZ[prefix]
    if (tz) return tz
  }
  if (stateAbbr) {
    const tz = STATE_TO_TZ[stateAbbr.toUpperCase()]
    if (tz) return tz
  }
...
/**
 * Get short timezone label (ET, CT, MT, PT, etc.)
 */
...
export type CallWindowStatus = "green" | "yellow" | "red"

/**
 * Determine call window status based on the local hour in the lead's timezone.
 * GREEN: 9:00 AM - 6:59 PM (safe to call)
 * YELLOW: 7:00 PM - 7:59 PM (caution)
 * RED: 8:00 PM - 8:59 AM (do not call)
 */
export function getCallWindowStatus(timezone: string): CallWindowStatus {
  const localTime = getTimeInZone(timezone)
  const hour = localTime.getHours()
  const minutes = localTime.getMinutes()

  // 9:00 AM (hour 9) through 6:59 PM (hour 18)
  if (hour >= 9 && hour < 19) return "green"
  // 7:00 PM (hour 19) through 7:59 PM
  if (hour === 19) return "yellow"
  // Everything else: 8:00 PM through 8:59 AM
  return "red"
}
