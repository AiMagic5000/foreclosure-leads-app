    ...
    <div className="mx-auto max-w-xl p-8">
      <div className="rounded-2xl border border-violet-200 bg-violet-50 p-8 text-center">
        ...
        <div className="mt-5 flex flex-col sm:flex-row gap-3 justify-center">
          <a href="/dashboard/settings" className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#D82221] px-5 py-2.5 text-sm font-bold text-white transition hover:opacity-90">Upgrade Your Plan</a>
