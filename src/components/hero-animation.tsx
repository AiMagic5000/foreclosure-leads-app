      ...
      >
        <defs>
          <linearGradient id="sunsetFill" x1="0%" y1="100%" x2="0%" y2="0%">
            ...
            <stop offset="40%" stopColor="#f87171" stopOpacity="0.1" />
        ...
        {[
          ...
          { x: 500, y: 620, delay: 2, size: 24, color: '#dc2626' },
          { x: 700, y: 600, delay: 0.5, size: 20, color: '#10b981' },
          { x: 850, y: 620, delay: 1.5, size: 22, color: '#dc2626' },
        ...
        <circle cx="600" cy="350" r="350" fill="none" stroke="#dc2626" strokeWidth="1" strokeOpacity="0.04" strokeDasharray="35,20">
